...
todos los productos que hay .MODIFICACION ahora quieres que cuando muestre los productos de la tienda sea un input con el que podamos actualizar el stock -->
...
<body>
    <div id="encabezado">
        <h1>Ejercicio : Conjuntos de resultados en MySQLii</h1>
